...
public class DeudaClienteSubscripcionList extends GridList {
	private static final long serialVersionUID = 1L;
	DecimalFormat formateador = new DecimalFormat("###,###");
	private ClienteEJB clienteEJB;
	private InscripcionEJB inscripcionEJB;

	public DeudaClienteSubscripcionList() {
		super();
...
//					cursosDeLaLista.setValue(subsDeLaBD);
	...
	public void setList(List<Subscripcion> pharmacyList, Subscripcion selected, ActividadYClase actYClaseSelected) {
		super.removeAll();
		this.setMultiple(false);
