...
public class GastosFilter extends GridFilter {
		...
		sucursal.addEventListener(Events.ON_CHANGE, new EventListener() {
			public void onEvent(Event evt){
				...
				if(sucursal.getSelectedItem() != null 
					...
					tipoGastoCB = GastosViewHelper.getComboBoxTipoGasto(tipoGastoCB, true, false);
					...
					tipoGastoCB.getItems().clear();
					tipoGastoCB = GastosViewHelper.getComboBoxTipoGastoMaipu(tipoGastoCB, true, false);
