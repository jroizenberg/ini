...
public class ProductoVentaList2 extends PanelRoutingCrud<Producto> {
	private static final long serialVersionUID = 1L;
	DecimalFormat formateador = new DecimalFormat("###,###");

	public ProductoVentaList2() {
		super();
		this.setCheckbox();
		this.setUIEvent();
...
//		this.addAuxheader(I18N.getLabel("producto.nombre")			, 1,1);
		...
		this.addAuxheader(I18N.getLabel("producto.cantidad.a.comprar")	, 1,1, "3%");
		...
		if(productosList != null){
			for (Producto prod : productosList) {
				...
				if(!isFromVenta)  // se selecciona desde el selector
					this.addField(new Intbox(prod.getCantidad()));  // deberia poner todo en 0
				else
