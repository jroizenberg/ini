...
public class VentaProductosPagarBotonesFilter extends GridCrud{
	...
	public VentaProductosPagarBotonesFilter() {
		super();
		setId("refresh3");
		makeFields();
	}
	...
	private void makeFields(){
	   ...
	   private org.zkoss.zul.Toolbar makeToolbar() {
           ...
           pagarButton.setLabel("Abonar Productos");
           pagarButton.setTooltip("Abonar Productos");
