...
public class MatriculaGratisList extends GridList {
	private static final long serialVersionUID = 1L;

	public MatriculaGratisList() {
		super();
//		this.setCheckmark(false);
		...
		super.addHeader(new Listheader("Matricula Gratis")).setWidth("15%");;
	...
	public void setList(List<Inscripcion> clienteList) {
		...
		if(clienteList != null){
			...
			while (itPharmacy.hasNext()) {
				...
				if(cliente.getMatriculaGratis() != null && cliente.getMatriculaGratis()){
					row.appendChild(new Listcell("SI"));	
				}else{
