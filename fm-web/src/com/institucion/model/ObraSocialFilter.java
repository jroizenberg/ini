...
public class ObraSocialFilter extends GridFilter {
	private static final long serialVersionUID = 1L;

	private Textbox nombre;
	private CursosCrudDelegate delegate;

	public ObraSocialFilter()	{
		super();
	...
	public String getFilters(){
		...
		StringBuilder actionConditions= new StringBuilder( "select id from obrasocial clase  ");
