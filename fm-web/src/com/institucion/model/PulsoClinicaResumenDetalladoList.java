...
public class PulsoClinicaResumenDetalladoList extends PanelRoutingCrud<PulsoClinicaDetalle> {
	...
	public PulsoClinicaResumenDetalladoList() {
		super();
		this.setCheckbox();
		this.setUIEvent();
	...
	protected boolean setPanelTitle() {
			...
			this.addAuxheader("ENERO", 2, 1, "20%");
			this.addColumn("Efect", true, "15%");
			this.addColumn("Obra S", true, "15%");
			
			this.addAuxheader("FEBRERO", 2, 1, "20%");
			this.addColumn("Efect", true, "15%");
			this.addColumn("Obra S", true, "15%");

			this.addAuxheader("MARZO", 2, 1, "20%");
			this.addColumn("Efect", true, "15%");
			this.addColumn("Obra S", true, "15%");

			this.addAuxheader("ABRIL", 2, 1, "20%");
			this.addColumn("Efect", true, "15%");
			this.addColumn("Obra S", true, "15%");

			this.addAuxheader("MAYO", 2, 1, "20%");
			this.addColumn("Efect", true, "15%");
			this.addColumn("Obra S", true, "15%");

			this.addAuxheader("JUNIO", 2, 1, "20%");
			this.addColumn("Efect", true, "15%");
			this.addColumn("Obra S", true, "15%");
						...
						for (PulsoClinicaDetalleParte2 pulsoClinicaDetalle : prod.getList()) {
							...
							if(pulsoClinicaDetalle.getIdActividad() == idActividad.intValue()){
								...
								if(pulsoClinicaDetalle.getCantidadIngresoObraSocial() != null && 
									...
									Label plata = null;
									plata= new Label("$"+formateador.format(pulsoClinicaDetalle.getCantidadIngresoObraSocial()));
									this.addField(plata);
								}else
									this.addField(new Label(" "));
