...
import com.institucion.model.EmpleadoFilter;
import com.institucion.model.EmpleadoList;

public class EmpleadoSelectorComposer extends SelectorFEComposer implements CursosCrudDelegate{
	
	private EmpleadoList clasepanelListGrid;
	private List<Empleado> pharmacyList;
	private PanelFilter filter;
	private EmpleadoEJB claseEJB;

	public EmpleadoSelectorComposer(){
		super();
		claseEJB = (EmpleadoEJB) BeanFactory.<EmpleadoEJB>getObject("fmEjbEmpleado");
	}

	private EmpleadoFilter getFilter() {
		return (EmpleadoFilter)(filter.getGridFilter());
	}
...
//		getFilter().clear();
	...
	public void onUpdate(Event event) throws Exception{
		...
		if (hasSelectedOneItem(clasepanelListGrid)){
			Sessions.getCurrent().setAttribute("idEmpleado", clasepanelListGrid.getSelectedItem().getValue());		
			super.saveHistory("filter");
			super.gotoPage("/institucion/empleado-crud.zul");		
		}
	}
	...
	public void onInsert(Event event) throws Exception {
		...
		com.institucion.fm.conf.Session.setAttribute("idEmpleado", null);
		super.saveHistory("filter");
		super.gotoPage("/institucion/empleado-crud.zul");
	...
	public void onFind() {
		...
		pharmacyList= new ArrayList<Empleado>();
