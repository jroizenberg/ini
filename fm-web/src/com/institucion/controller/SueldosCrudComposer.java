...
import com.institucion.model.SueldosCrud;
import com.institucion.model.SueldosMaipuCrud;
import com.institucion.model.TipoMovimientoCajaEnum;

public class SueldosCrudComposer extends CrudComposer  implements GastosDelegate, SucursalDelegate{

	private PanelCrud gastosCrud;
	public final String idGasto = "idSueldo";
	...
	private SueldosMaipuCrud getGastosMaipuCrud() {
		return (SueldosMaipuCrud)(sucMaipu.getGridCrud());
	}
...
//								pagoNuevo.setSaldadaDeuda(true);
						...
						if (Sessions.getCurrent().getAttribute("isClienteFromIngresoInscripcion") != null){ 
							...
							super.gotoPage("/institucion/sueldos-selector.zul");
...
//						pagoNuevo.setSaldadaDeuda(true);
	...
	private SueldosCrud getClienteCrud() {
		return (SueldosCrud) (gastosCrud.getGridCrud());
	}

	private GastosMaipu fromViewToModel(GastosMaipu cliente) {
		
		cliente.setTipoGasto(GastosMaipuEnum.SUELDOS);
	...
	private Gastos fromViewToModel(Gastos cliente) {
		cliente.setTipoGasto(GastosEnum.SUELDOS);
